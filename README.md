# Stillroom Lab v0 — tickets 01–02
...
read-only source guarantees and sandbox limitations. No ticket-03+ features exist.
...
(permission enforcement, governed queries, metrics and proof manifests) is absent.
